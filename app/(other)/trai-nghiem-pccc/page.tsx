...
export default function Page() {
  ...
  const images = data?.$files?.map(($file: any) => $file.url) || []
  ...
  return (
    ...
    >
      {isLoading ? (
        <div className="absolute top-0 z-10 mt-8 flex items-center justify-center text-center">
        ...
        <>
          ...
          >
            ...
            <Link href="https://maps.app.goo.gl/hPzAMmZQ6kCj2t9Z9" target="_blank" prefetch={false}>
              <img src="/other/station.avif" alt="pccc" className="h-26 rounded-lg md:h-40" />
            </Link>
          </motion.div>
        </>
      )}
